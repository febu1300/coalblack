...
<ul class="nav nav-pills flex-column">
    ...
    <li class="nav-item"><?= $this->Html->link(__('Dashboard'), ['controller' => 'Dashboard', 'action' => 'index']) ?></li>
           ...
           <li class="nav-item"><?= $this->Html->link(__('Hauptkatagorieliste'), ['controller'=>'MainCatagories','action' => 'index']) ?></li>
           <li class="nav-item"><?= $this->Html->link(__('Produktskatagorieliste'), ['controller'=>'ProductsCatagories','action' => 'index']) ?></li>
