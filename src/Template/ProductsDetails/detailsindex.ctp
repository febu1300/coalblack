    ...
    <table class="table table-sm table-bordered">
        <thead>
            <tr>
                ...
                <th scope="col" class="actions"><?= __('Detail hinzufügen') ?></th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link(__(' '), ['action' => 'bearbeiten', $product->id],['class'=>"glyphicon glyphicon-plus",'data-toggle'=>"modal",'data-target'=>"#editProduct"]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
