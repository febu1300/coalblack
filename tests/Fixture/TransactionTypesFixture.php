...
class TransactionTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'transaction_type_name' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            'id' => 1,
            'transaction_type_name' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
