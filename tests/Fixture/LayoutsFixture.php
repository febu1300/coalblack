...
class LayoutsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'layout_name' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'layout_name' => 'Lorem ipsum dolor sit amet',
