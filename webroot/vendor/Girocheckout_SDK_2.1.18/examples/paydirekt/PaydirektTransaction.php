...
try {
  ...
  $oCart->addItem( "Helm", 1, 2599, "7081519198672" );
	...
	$request->addParam('merchantId',$merchantID)
	        ...
	        ->addParam('purpose','Scooter-Zentrale-768')
          ->addParam('shoppingCartType','MIXED')
          //->addParam('type', 'SALE')
	        //->addParam('shippingAmount','0')
	        ->addParam('shippingAddresseFirstName','Sven')
	        ->addParam('shippingAddresseLastName','Neumann')
          ->addParam('shippingEmail','mheumann@gmail.com')
          //->addParam('shippingCompany','Elektro Neumann')
          //->addParam('shippingStreet','Nimrodstr. 25')
	        ->addParam('shippingZipCode','90441')
	        ->addParam('shippingCity','Nürnberg')
	        ->addParam('shippingCountry','DE')
	        //->addParam('orderAmount',2995)
          ->addParam('merchantReconciliationReferenceNumber','343-4343-39829')
	        ->addParam('orderId','768')
